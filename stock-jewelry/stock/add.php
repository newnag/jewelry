            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="body_weight" placeholder="" value="<?=$query_body['0']['weight']?>" readonly>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="body_cost" placeholder="" value="<?=$query_body['0']['price']?>" readonly>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control" id="type_build">
                      <option value="">เลือกประเภทผลิต</option>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="other_cost" placeholder="" value="">
                </div>
              </div>  
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="add-loose-weight">น้ำหนัก</label>
          <input type="number" class="form-control" min="0" id="add-loose-weight" placeholder="">
        </div>
      </div>
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default" data-dismiss="modal">ปิด</button>
        <button type="button" class="btn btn-primary" onclick="add_loose_modal_ori()">เพิ่ม</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
