    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-12"><button class="btn btn-gold" onclick="add()"><i class="fas fa-plus"></i> เพิ่มรายการขาย</button></div>
                  </div>
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="search">
                            ...
                            <input type="text" class="form-control" id="search_name" placeholder="ค้นหาเบอร์ลูกค้า/รหัสสินค้า">
                          </div>
                        </div>
...
<script type="text/javascript">
  ...
  function add(){
    location.href = "https://thavorn-jewelry.com/stock-jewelry/barcode/add.php"
  }
</script>
