                                        ...
                                        <td>
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6"><button type="button" class="btn btn-block bg-gradient-danger btn-cus-w" onclick="">ลบ</button></div>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="supplier_name">เลขผู้เสียภาษี</label>
          <input type="text" class="form-control" id="tax_id" placeholder="ใส่เลขผู้เสียภาษี">
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label for="supplier_name_edit">เลขผู้เสียภาษี</label>
            <input type="text" class="form-control" id="tax_id_edit" placeholder="ใส่เลขผู้เสียภาษี">
        </div>
      ...
      <div class="modal-footer justify-content-between">
        <button type="button" class="btn btn-default" data-dismiss="modal">ปิด</button>
        <button type="button" class="btn btn-primary" onclick="">แก้ไข</button>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
