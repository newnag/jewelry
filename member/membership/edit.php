    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control input-dis" disabled value="<?=$query['id_customer']?>">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="">แต้มคะแนน</label>
                    <input type="number" class="form-control" id="point" value="<?=$query['point']?>">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-6 pic1">
                  <div class="col-12">
                    <label for="">อัพโหลดรูปบัตรประชาชน</label>
                  </div>
                  <div class="col-12">
                  ...
                  <div class="col-12">
                    <div class="btn-group">
                      <button type="button" class="btn btn-select" onclick="select_pic('1')">เลือกรูปภาพ</button>
          ...
          <div class="row mb-2">
            <div class="col-auto"><button class="btn btn-save" onclick="update()">บันทึก</button></div>
            <div class="col-auto"><button class="btn btn-back" onclick="goback()">กลับ</button></div>
            <?php
              if($_SESSION['role'] == 1){
                echo '<div class="col-auto"><button class="btn btn-del" onclick="item_delete('.$_GET['id'].')">ลบ</button></div>';
              }
            ?>
          </div>
        </div>
