                        ...
                        <tbody>
                          <?php
                            for($i=0;$i<count($getcate);$i++){
                              $get_his_add[$i] = $stock->call_history($getcate[$i]['id'],3,1);
                              $get_his_remove[$i] = $stock->call_history($getcate[$i]['id'],3,2);
                              ...
                              $amount_cate = $stock->amount_table($getcate[$i]['id'],3);
                              if($amount_cate == ""){
                                $amount_cate = "0";
                              }
...
<script type="text/javascript">
  ...
  function add_new(){
      location.href = "https://thavorn-jewelry.com/stock-gold/border/add.php"
  }

  function edit(id){
    location.href = `https://thavorn-jewelry.com/stock-gold/border/edit.php?id=${id}`
  }
</script>
