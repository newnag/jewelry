    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="tax_id" placeholder="ใส่ Tax Id.">
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="tax_id_edit">Tax Id.</label>
          <input type="text" class="form-control" id="tax_id_edit" placeholder="ใส่ Tax Id.">
        </div>
